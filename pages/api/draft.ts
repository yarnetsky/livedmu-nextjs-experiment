...
export default async function preview(
  ...
  // Check if the story with the given `slug` exists
  const story = await client.fetch(storyBySlugQuery, {
    slug: req.query.slug,
  })
  ...
  redirectToPreview(res, `/stories/${story.slug}`)
}
